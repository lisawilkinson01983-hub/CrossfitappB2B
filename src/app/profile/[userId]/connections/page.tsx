    ...
    <main className="mx-auto max-w-2xl px-4 py-8">
      ...
      <div className="mt-4 flex gap-4 border-b border-gray-200 text-sm font-medium">
        <Link
          ...
          className={`pb-2 ${activeTab === "followers" ? "border-b-2 border-blue-600 text-blue-600" : "text-gray-500"}`}
        >
          Followers
        </Link>
        <Link
          href={`/profile/${userId}/connections?tab=following`}
          className={`pb-2 ${activeTab === "following" ? "border-b-2 border-blue-600 text-blue-600" : "text-gray-500"}`}
        >
          Following
        </Link>
      </div>
